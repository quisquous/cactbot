...
FakeACT.prototype.encounterDPSInfo = function() {
    testingDPS.Encounter.DURATION++;
    return JSON.stringify(testingDPS.Encounter);
};

FakeACT.prototype.combatantDPSInfo = function() {
    var combatants = []
    for (var key in testingDPS.Combatant) {
        testingDPS.Combatant[key].damage = parseFloat(testingDPS.Combatant[key].damage) +
            Math.floor(Math.random() * 10000);
        combatants.push(testingDPS.Combatant[key]);
    }
...
FakeACT.prototype.testThordan = function () {
    window.fakeact = {
        zone: 'Thordan\'s Reign (Extreme)',
        incombat: true,
        combatants: [makeCombatant('King Thordan')],
        logs: ['Your feeble light shall fade before my brilliance']
    };
};
...
FakeACT.prototype.testBees = function () {
    window.fakeact = {
        ...
        logs: ['You use Dragon Kick']
    };
};

FakeACT.prototype.testA1Savage = function () {
    window.fakeact = {
        zone: 'The Fist Of The Father (Savage)',
        incombat: true,
...
FakeACT.prototype.testA3Savage = function () {
    window.fakeact = {
        zone: 'The Arm Of The Father (Savage)',
        incombat: true,
...
FakeACT.prototype.testA4Savage = function () {
    window.fakeact = {
        zone: 'The Burden Of The Father (Savage)',
        incombat: true,
        combatants: [makeCombatant('Manipulator')],
        logs: ['The Manipulator uses Hydrothermal Missile']
    };
};

FakeACT.prototype.testA5Savage = function () {
    window.fakeact = {
        zone: 'The Fist Of The Son (Savage)',
        incombat: true,
        combatants: [makeCombatant('Ratfinx')],
        logs: ['Advanced Clevering will be sealed off in']
    };
};

FakeACT.prototype.testA7Savage = function () {
    window.fakeact = {
        zone: 'Alexander - The Arm Of The Son (Savage)',
        incombat: true,
        combatants: [makeCombatant('Quickthinx')],
        logs: ['The electrocution gallery will be sealed off in']
    };
};

FakeACT.prototype.testA8Savage = function () {
    window.fakeact = {
        zone: 'Alexander - The Burden Of The Son (Savage)',
        incombat: true,
        combatants: [makeCombatant('Brute Justice')],
        logs: ['Combat protocols restarting blah blah blah']
    };
};
