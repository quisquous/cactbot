...
type TargetedResponseFunc = ResponseFunc<TargetedMatches>;
type TargetedFunc = TriggerFunc<TargetedMatches, TriggerOutput>;
type StaticResponseFunc = ResponseFunc<unknown>;
