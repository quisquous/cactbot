...
var gBossFightTriggers = [
  ...
  {
    id: 'o5s',
    zoneRegex: /(Sigmascape V1.0 \(Savage\)|Unknown Zone \(2BC\))/,
    startRegex: /:Alte Roite uses Wyrm Tail/,
    endRegex: /:Alte Roite was defeated by/,
    countdownStarts: true,
  },
  {
    id: 'o6s',
    zoneRegex: /(Sigmascape V2.0 \(Savage\)|Unknown Zone \(2BD\))/,
    startRegex: /:Alte Roite uses Wyrm Tail/,
    endRegex: /:Alte Roite was defeated by/,
    countdownStarts: true,
  },
  {
    id: 'o7s',
    zoneRegex: /(Sigmascape V3.0 \(Savage\)|Unknown Zone \(2BE\))/,
    startRegex: /:Alte Roite uses Wyrm Tail/,
    endRegex: /:Alte Roite was defeated by/,
    countdownStarts: true,
  },
  {
    id: 'o8s',
    zoneRegex: /(Sigmascape V4.0 \(Savage\)|Unknown Zone \(2BF\))/,
    startRegex: /:Alte Roite uses Wyrm Tail/,
    endRegex: /:Alte Roite was defeated by/,
    countdownStarts: true,
  },
