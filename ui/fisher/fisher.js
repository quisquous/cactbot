  ...
  constructor(element) {
    ...
    this.regex = {
      ...
      'ko': {
        ...
        'catch': /00:0843:(?:[\w'가-힣]+) 님이 (?:[\ue0bb\ue03c\s가-힣]+)\(\d+\.\d일름\)(?:을|를) 낚았습니다./,
        ...
        'mooch': /00:08c3:(?:[\w'가-힣]+) 님이 방금 낚은 (?:[\ue0bb\ue03c\s가-힣]+)(?:을|를) 조심스럽게 물에 넣고 생미끼 낚시를 시도합니다\./,
        'chumgain': /00:08ae:(?:[\w'가-힣]+)(?:이|가) \ue0bb?\ue05c?밑밥 효과를 받았습니다\./,
        'chumfade': /00:08b0:(?:[\w'가-힣]+)의 \ue0bb?\ue05c?밑밥 효과가 사라졌습니다\./,
        'snaggain': /00:08ae:(?:[\w\s\ue06f'가-힣]+)(?:이|가) \ue0bb?\ue05c?갈고리 낚시 효과를 받았습니다\./,
