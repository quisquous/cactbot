...
class TimerBar extends HTMLElement {
  static get observedAttributes() { return [ "duration", "value", "elapsed", "hideafter", "lefttext", "centertext", "righttext", "width", "height", "bg", "bgborder", "fg", "style", "toward" ]; }
  ...
  set bgborder(c) { this.setAttribute("bgborder", c); }
  get bgborder() { return this.getAttribute("bgborder"); }
  ...
  //  this._bg = 'rgba(49, 32, 8, 1)';
  //  this._bgborder = 'rgba(170, 110, 3, 1)';
