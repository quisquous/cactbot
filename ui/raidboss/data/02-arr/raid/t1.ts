...
const triggerSet: TriggerSet<Data> = {
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.ability({ source: '蛇杖击', id: '4B8.*?', capture: false }),
      netRegexKo: NetRegexes.ability({ source: '뱀 지팡이', id: '4B8.*?', capture: false }),
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.ability({ source: '蛇杖击', id: '4BA' }),
      netRegexKo: NetRegexes.ability({ source: '뱀 지팡이', id: '4BA' }),
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.addedCombatant({ name: '蛇杖击', capture: false }),
      netRegexKo: NetRegexes.addedCombatant({ name: '뱀 지팡이', capture: false }),
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.ability({ source: '蛇杖击', id: '4B8' }),
      netRegexKo: NetRegexes.ability({ source: '뱀 지팡이', id: '4B8' }),
      condition: Conditions.targetIsYou(),
      delaySeconds: 8,
      suppressSeconds: 5,
