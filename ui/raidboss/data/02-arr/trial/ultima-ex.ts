  ...
  triggers: [
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ id: '5EA', source: 'Ultima-Waffe', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ id: '5EA', source: 'Ultima Arma', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ id: '5EA', source: 'アルテマウェポン', capture: false }),
      netRegexCn: NetRegexes.startsUsing({ id: '5EA', source: '究极神兵', capture: false }),
      netRegexKo: NetRegexes.startsUsing({ id: '5EA', source: '알테마 웨폰', capture: false }),
