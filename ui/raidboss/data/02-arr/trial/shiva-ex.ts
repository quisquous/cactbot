  ...
  triggers: [
    {
      ...
      response: (data, _matches, output) => {
        ...
        if (data.role === 'tank') {
          if (data.currentTank !== undefined && data.currentTank.length > 0 && data.blunt[data.currentTank])
    ...
    },
    {
      ...
      response: (data, _matches, output) => {
        ...
        if (data.role === 'tank') {
          if (data.currentTank !== undefined && data.currentTank.length > 0 && data.slashing[data.currentTank])
