  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        '--auto--': '--平A--',
        'Abyssal Fires': '火炎风暴',
        'Aionagonia': 'Aionagonia',
        'Aioniopyr': 'Aioniopyr',
        'Arcane Channel': 'Arcane Channel',
        'Arcane Control': 'Arcane Control',
        'Ashing Blaze': '激火燃灰',
        'Blazing Footfalls': '炽热践踏',
        'Blood of the Gorgon': 'Blood of the Gorgon',
        'Breath of the Gorgon': 'Breath of the Gorgon',
        'Burst': '爆炸',
        'Conceptual Diflare': 'Conceptual Diflare',
        'Conceptual Octaflare': 'Conceptual Octaflare',
        'Conceptual Shift': 'Conceptual Shift',
        'Conceptual Tetraflare': 'Conceptual Tetraflare',
        'Creation on Command': '创造命令',
        'Crown of the Gorgon': 'Crown of the Gorgon',
        'Cthonic Vent': '喷炎升蛇',
        'Deconceptualize': '概念消除',
        'Dominion': 'Dominion',
        'Ego Death': '自我概念崩坏',
        'Ektothermos': '爆热波动',
        'Emergent Diflare': 'Emergent Diflare',
        'Emergent Octaflare': 'Emergent Octaflare',
        'Emergent Tetraflare': 'Emergent Tetraflare',
        'End of Days': '米吉多烈焰',
        'Everburn': 'Everburn',
        'Eye of the Gorgon': 'Eye of the Gorgon',
        '(?<!Nest of )Flameviper': '炎蛇炮',
        'Footprint': '践踏',
        'Forcible Difreeze': 'Forcible Difreeze',
        'Forcible Fire II(?!I)': 'Forcible Fire II(?!I)',
        'Forcible Fire III': 'Forcible Fire III',
        'Forcible Trifire': 'Forcible Trifire',
        ...
        'Inverse Magicks': 'Inverse Magicks',
        'Limitless Desolation': '万象灰烬',
        'Manifold Flames': 'Manifold Flames',
        'Natural Alignment': 'Natural Alignment',
        'Nest of Flamevipers': 'Nest of Flamevipers',
        '(?<! )Octaflare': '(?<! )Octaflare',
        'Orogenic Deformation': 'Orogenic Deformation',
        'Orogenic Shift': 'Orogenic Shift',
        'Petrifaction': '石化',
        ...
        'Torch Flame': '灼炎',
        'Trailblaze': '踏火寻迹',
        'Twist Nature': 'Twist Nature',
        'Tyrant\'s Fire III': '暴君爆炎',
        'Tyrant\'s Flare(?! II)': '暴君核爆',
        'Tyrant\'s Flare II': '暴君核爆II',
        'Tyrant\'s Unholy Darkness': 'Tyrant\'s Unholy Darkness',
        'Uplift': '隆起',
