...
const triggerSet: TriggerSet<Data> = {
  ...
  triggers: [
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'TODO', source: 'Aloalo Wood Golem', capture: false },
      response: Responses.getBehind('info'),
    },
    {
      id: 'AAIS Islekeeper Gravity Force',
      type: 'StartsUsing',
      netRegex: { id: 'TODO', source: 'Aloalo Islekeeper' },
      response: Responses.stackMarkerOn(),
    },
    {
    ...
    // ---------------- Lala ----------------
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'TODO', source: 'Lala', capture: false },
      response: Responses.aoe(),
    },
    {
    ...
    },
    {
      ...
      type: 'Ability',
      netRegex: { id: ['TODO', 'TODO'], source: 'Lala' },
      run: (data, matches) => data.lalaBossTimes = matches.id === 'TODO' ? 3 : 5,
    },
    {
      id: 'AAIS Lala Arcane Blight',
      type: 'StartsUsing',
      netRegex: { id: ['TODO1', 'TODO2', 'TODO3', 'TODO4'], source: 'Lala' },
      alertText: (data, matches, output) => {
        const initialDir = {
          'TODO1': 2, // initial back safe
          'TODO2': 0, // initial front safe
          'TODO3': 1, // initial right safe
          'TODO4': 3, // initial left safe
        }[matches.id];
