  ...
  triggers: [
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '673E', source: '얼굴', capture: false }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6743', source: '얼굴', capture: false }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6742', source: '얼굴' }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.gainsEffect({ effectId: 'ACB', source: '작은 얼굴' }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.losesEffect({ effectId: 'ACB', source: '작은 얼굴' }),
      condition: Conditions.targetIsYou(),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.gainsEffect({ effectId: 'ACC', source: '작은 얼굴' }),
      condition: Conditions.targetIsYou(),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.losesEffect({ effectId: 'ACC', source: '작은 얼굴' }),
      condition: Conditions.targetIsYou(),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6738', source: '얼굴', capture: false }),
      suppressSeconds: 1,
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6745', source: '프레임워커', capture: false }),
      response: Responses.aoe(),
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6744', source: '프레임워커' }),
      response: Responses.tankBuster(),
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6752', source: '빅치즈', capture: false }),
      response: Responses.aoe(),
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '674F', source: '빅치즈', capture: false }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6750', source: '빅치즈', capture: false }),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6751', source: '빅치즈' }),
      response: Responses.tankBuster(),
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6755', source: '빅치즈' }),
      condition: Conditions.targetIsYou(),
    ...
    },
    {
      ...
      netRegexKo: NetRegexes.startsUsing({ id: '6753', source: '빅치즈' }),
