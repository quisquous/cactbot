...
[{
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegex: NetRegexes.startsUsing({ id: '1C45', source: 'Lava Scorpion' }),
      netRegexDe: NetRegexes.startsUsing({ id: '1C45', source: 'Lavaskorpion' }),
      netRegexFr: NetRegexes.startsUsing({ id: '1C45', source: 'scorpion de lave' }),
      netRegexJa: NetRegexes.startsUsing({ id: '1C45', source: 'ラーヴァ・スコーピオン' }),
      netRegexCn: NetRegexes.startsUsing({ id: '1C45', source: '熔岩蝎' }),
