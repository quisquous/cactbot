...
[{
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceSync': {
        'Destroy! Destroy! Destroy! I will destroy it all!': 'どれもこれもゼ～ンブ、ハカイ、ハカイ、ハカイ！ ゼ～ンブ、ハカイだ！！',
        'Graven Image': '神々の像',
        'Kefka': 'ケフカ',
      },
      'replaceText': {
    ...
    },
    {
      ...
      'missingTranslations': true,
      'replaceSync': {
        'Destroy! Destroy! Destroy! I will destroy it all!': '我要破坏一切！破坏！破坏！破坏！ 全都破坏掉！',
        'Graven Image': '众神之像',
        'Kefka': '凯夫卡',
      },
      'replaceText': {
    ...
    },
    {
      ...
      'missingTranslations': true,
      'replaceSync': {
        'Destroy! Destroy! Destroy! I will destroy it all!': '이것저것 모~두, 파괴, 파괴, 파괴! 모~두 파괴한다!!',
        'Graven Image': '신들의 상',
        'Kefka': '케프카',
      },
      'replaceText': {
