...
export default {
  ...
  triggers: [
    ...
    {
      id: 'UWU Titan Bomb Burst',
      netRegex: NetRegexes.startsUsing({ id: '2B6A', source: 'bomb boulder', capture: false }),
      netRegexDe: NetRegexes.startsUsing({ id: '2B6A', source: 'Bomber-Brocken', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ id: '2B6A', source: 'bombo rocher', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ id: '2B6A', source: 'ボムボルダー', capture: false }),
      netRegexCn: NetRegexes.startsUsing({ id: '2B6A', source: '爆破岩石', capture: false }),
      netRegexKo: NetRegexes.startsUsing({ id: '2B6A', source: '바위폭탄', capture: false }),
      suppressSeconds: 1,
      alertText: (data, _, output) => output.text(),
      outputStrings: {
        text: {
    ...
    {
      id: 'UWU Titan Land Weight',
      netRegex: NetRegexes.startsUsing({ id: '2B65', source: 'Titan', capture: false }),
      netRegexDe: NetRegexes.startsUsing({ id: '2B65', source: 'Titan', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ id: '2B65', source: 'Titan', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ id: '2B65', source: 'タイタン', capture: false }),
      netRegexCn: NetRegexes.startsUsing({ id: '2B65', source: '泰坦', capture: false }),
      netRegexKo: NetRegexes.startsUsing({ id: '2B65', source: '타이탄', capture: false }),
      suppressSeconds: 1,
      alertText: (data, _, output) => output.text(),
      outputStrings: {
        text: {
