  ...
  triggers: [
    {
      ...
      regexDe: Regexes.startsUsing({ id: '36E0', source: 'Skalli', capture: false }),
      regexFr: Regexes.startsUsing({ id: '36E0', source: 'Sköll', capture: false }),
      regexJa: Regexes.startsUsing({ id: '36E0', source: 'スコル', capture: false }),
      regexCn: Regexes.startsUsing({ id: '36E0', source: '斯库尔', capture: false }),
    ...
    },
    {
      ...
      regexDe: Regexes.startsUsing({ id: '46BD', source: 'Skalli', capture: false }),
      regexFr: Regexes.startsUsing({ id: '46BD', source: 'Sköll', capture: false }),
      regexJa: Regexes.startsUsing({ id: '46BD', source: 'スコル', capture: false }),
      regexCn: Regexes.startsUsing({ id: '46BD', source: '斯库尔', capture: false }),
