...
export default {
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegexFr: NetRegexes.gameLog({ line: 'Vous détectez une? (?:filon de minerai|carrière de pierre|arbre mature|carré de végétation) évanescente? de niveau 80 du côté (?:est|sud|ouest|nord|nord-est|sud-est|nord-ouest|sud-ouest).*?', capture: false }),
