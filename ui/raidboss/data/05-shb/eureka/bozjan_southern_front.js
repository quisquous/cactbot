...
export default {
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.startsUsing({ source: '贯雷枪布里欧纳克', id: '51DD' }),
      condition: tankBusterOnParty(),
      response: Responses.tankBuster(),
    },
    {
      ...
      netRegexCn: NetRegexes.startsUsing({ source: '贯雷枪布里欧纳克', id: '51CE', capture: false }),
      condition: (data) => !data.helldiver,
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.startsUsing({ source: '贯雷枪布里欧纳克', id: '51CF', capture: false }),
      condition: (data) => !data.helldiver,
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.startsUsing({ source: '贯雷枪布里欧纳克', id: '51CD', capture: false }),
      condition: (data) => !data.helldiver,
      delaySeconds: 6.5,
      infoText: (data, _, output) => output.text(),
      outputStrings: {
    ...
    },
    {
      ...
      netRegexCn: NetRegexes.startsUsing({ source: '贯雷枪布里欧纳克', id: '51D0', capture: false }),
      condition: (data) => !data.helldiver,
