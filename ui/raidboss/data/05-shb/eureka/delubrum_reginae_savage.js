...
export default {
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegex: NetRegexes.startsUsing({ source: 'The Queen', id: '5B77', capture: false }),
      netRegexDe: NetRegexes.startsUsing({ source: 'Kriegsgöttin', id: '5B77', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Garde-La-Reine', id: '5B77', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'セイブ・ザ・クイーン', id: '5B77', capture: false }),
      condition: Conditions.caresAboutAOE(),
      suppressSeconds: 1,
      response: Responses.bigAoe(),
    },
