...
export default {
  ...
  triggers: [
    ...
    },
    {
      ...
      outputStrings: {
        text: {
          ...
          de: 'Geh entgegengesetzt zum ersten Ansturm',
        },
      },
    },
    {
    ...
    // *** Queen's Guard ***
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ source: 'Soldat Der Königin', id: '56BE', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Soldat De La Reine', id: '56BE', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'クイーンズ・ソルジャー', id: '56BE', capture: false }),
    ...
    },
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ source: 'Soldat Der Königin', id: '5810', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Soldat De La Reine', id: '5810', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'クイーンズ・ソルジャー', id: '5810', capture: false }),
      condition: Conditions.caresAboutAOE(),
      response: Responses.aoe(),
    },
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ source: 'Soldat Der Königin', id: '57FF', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Soldat De La Reine', id: '57FF', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'クイーンズ・ソルジャー', id: '57FF', capture: false }),
      alertText: (data, _, output) => output.text(),
      outputStrings: {
        text: {
    ...
    },
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ source: 'Soldat Der Königin', id: '57FC', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Soldat De La Reine', id: '57FC', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'クイーンズ・ソルジャー', id: '57FC', capture: false }),
      alertText: (data, _, output) => {
    ...
    },
    {
      ...
      netRegexDe: NetRegexes.startsUsing({ source: 'Soldat Der Königin', id: '5759D4FF', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ source: 'Soldat De La Reine', id: '5759D4FF', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ source: 'クイーンズ・ソルジャー', id: '5759D4FF', capture: false }),
      run: (data) => data.reversalOfForces = true,
    },
    {
