  ...
  triggers: [
    {
      ...
      regexDe: Regexes.startsUsing({ source: 'Unbekannt(?:e|er|es|en)', id: '4B69', capture: false }),
      regexFr: Regexes.startsUsing({ source: 'Inconnu', id: '4B69', capture: false }),
      regexJa: Regexes.startsUsing({ source: '正体不明', id: '4B69', capture: false }),
      regexCn: Regexes.startsUsing({ source: '不明物体', id: '4B69', capture: false }),
      regexKo: Regexes.startsUsing({ source: '정체불명', id: '4B69', capture: false }),
    ...
    },
    {
      ...
      regexDe: Regexes.startsUsing({ source: 'Rukshs Dheem', id: '4B8C', capture: false }),
      regexFr: Regexes.startsUsing({ source: 'Rukshs Dheem', id: '4B8C', capture: false }),
      regexJa: Regexes.startsUsing({ source: 'ルクスィー・ディーマ', id: '4B8C', capture: false }),
      condition: Conditions.caresAboutPhysical(),
      response: Responses.tankBuster(),
    },
    {
      ...
      regexDe: Regexes.startsUsing({ source: 'Rukshs Dheem', id: '4B7E', capture: false }),
      regexFr: Regexes.startsUsing({ source: 'Rukshs Dheem', id: '4B7E', capture: false }),
      regexJa: Regexes.startsUsing({ source: 'ルクスィー・ディーマ', id: '4B7E', capture: false }),
