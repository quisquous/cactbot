  ...
  timelineReplace: [
    {
      ...
      'replaceSync': {
        ...
        'The Cornice will be sealed off': 'Noch 15 Sekunden bis sich der Zugang zu Schnittstelle schließt',
        'Aetherial Observation will be sealed off': 'Noch 15 Sekunden bis sich der Zugang zu Ätherobservationsdeck schließt',
        'Repurposing will be sealed off': 'Noch 15 Sekunden bis sich der Zugang zu Umrüstanlage schließt',
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Cladoselache': 'Cladoselache',
        'The Cornice will be sealed off': 'Fermeture Cœur du propulseur dimensionnel dans',
        'Aetherial Observation will be sealed off': 'Fermeture Observatoire des flux éthérés dans',
        'Repurposing will be sealed off': 'Fermeture Atelier d\'opti-rénovation dans',
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Levinball': '雷弾',
        'Cladoselache': 'クラドセラケ',
        'The Cornice will be sealed off': '次元潜行装置中枢の封鎖まであと',
        'Aetherial Observation will be sealed off': 'エーテル観測台の封鎖まであと',
        'Repurposing will be sealed off': '改装作業拠点の封鎖まであと',
    ...
    },
    {
      ...
      'replaceSync': {
        ...
        'Cladoselache': '클라도셀라케',
        'Engage!': '전투 시작!',
        'The Cornice will be sealed off': '15초 후에 개조 작업 거점이 봉쇄됩니다',
        'Aetherial Observation will be sealed off': '15초 후에 에테르 관측대가 봉쇄됩니다',
        'Repurposing will be sealed off': '15초 후에 차원 잠행 장치 중추가 봉쇄됩니다',
