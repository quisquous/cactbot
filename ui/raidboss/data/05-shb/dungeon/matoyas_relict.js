...
export default {
  ...
  triggers: [
    ...
    },
    {
      ...
      netRegex: NetRegexes.gainsEffect({ effectId: '5916' }),
      alarmText: {
        en: 'RUN AWAY',
        ja: 'ボスに離れ',
        cn: '远离即死区',
    ...
    },
    {
      ...
      netRegex: NetRegexes.startsUsing({ id: '5911', source: 'Mother Porxie', capture: false }),
      netRegexDe: NetRegexes.startsUsing({ id: '5911', source: 'Muttersau', capture: false }),
      netRegexFr: NetRegexes.startsUsing({ id: '5911', source: 'mère porxie', capture: false }),
      netRegexJa: NetRegexes.startsUsing({ id: '5911', source: 'マザーポークシー', capture: false }),
      condition: function(data, matches) {
        return data.me === matches.target || data.role === 'healer';
      },
      response: Responses.tankBuster(),
