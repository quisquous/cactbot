...
addOverlayListener('onPlayerChangedEvent', (e) => {
  ...
  if (jobInfo) {
    ...
    if (detail.job === 'RDM' && detail.jobDetail) {
      ...
      jobInfo.innerText =
        `${detail.jobDetail.feathers} | ${detail.jobDetail.esprit} | (${detail.jobDetail.steps}) | ${detail.jobDetail.currentStep}`;
      ...
      jobInfo.innerText =
        `${detail.jobDetail.lightningStacks} (${detail.jobDetail.lightningMilliseconds}) | ${detail.jobDetail.chakraStacks} | ${detail.jobDetail.lightningTimerFrozen.toString()}`;
    } else if (detail.job === 'PGL' && detail.jobDetail) {
      jobInfo.innerText =
        `${detail.jobDetail.lightningStacks} (${detail.jobDetail.lightningMilliseconds})`;
