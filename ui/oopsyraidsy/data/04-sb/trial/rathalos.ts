...
// Note: Ignoring Burns (629), which you get temporarily from being in stack marker / fire puddle.
...
const triggerSet: OopsyTriggerSet<Data> = {
  ...
  damageWarn: {
    ...
    'Rathalos Tail Smash': '286B', // first phase rear conal, paired with Mangle (2CB9)
    'Rathalos Tail Swing': '2CBB', // right side attack?
  ...
  shareWarn: {
    'Rathalos Fire Breath': '2CBD', // first phase red circle spread headmarker
  },
  shareFail: {
