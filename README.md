...
1. Follow the instructions in the **dummy.txt** file in [plugin/CactbotOverlay/ThirdParty/OverlayPlugin](plugin/CactbotOverlay/ThirdParty/OverlayPlugin).
1. Follow the instructions in the **dummy.txt** file in [plugin/CactbotOverlay/ThirdParty/ACT](plugin/CactbotOverlay/ThirdParty/ACT).
