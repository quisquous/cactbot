...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) ChatLog 00:(?<code>(?:....)):(?<name>(?:[^:]*)):(?<line>(?:.*))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) Territory 01:(?<id>(?:.*?)):(?<name>(?:.*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) AddCombatant 03:(?<id>(?:[0-9A-F]{8})):(?<name>(?:[^:]*?)):(?<job>(?:[^:]*?)):(?<level>(?:[^:]*?)):(?<ownerId>(?:[^:]*?)):(?<worldId>(?:[^:]*?)):(?<world>(?:[^:]*?)):(?<npcNameId>(?:[^:]*?)):(?<npcBaseId>(?:[^:]*?)):(?<currentHp>(?:[^:]*?)):(?<hp>(?:[^:]*?)):(?<currentMp>(?:[^:]*?)):(?<mp>(?:[^:]*?)):[^:]*?:[^:]*?:(?<x>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<y>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<z>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<heading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) RemoveCombatant 04:(?<id>(?:[0-9A-F]{8})):(?<name>(?:[^:]*?)):(?<job>(?:[^:]*?)):(?<level>(?:[^:]*?)):(?<ownerId>(?:[^:]*?)):(?<worldId>(?:[^:]*?)):(?<world>(?:[^:]*?)):(?<npcNameId>(?:[^:]*?)):(?<npcBaseId>(?:[^:]*?)):(?<currentHp>(?:[^:]*?)):(?<hp>(?:[^:]*?)):(?<currentMp>(?:[^:]*?)):(?<mp>(?:[^:]*?)):[^:]*?:[^:]*?:(?<x>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<y>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<z>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<heading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) PlayerStats 0C:(?<job>(?:\d+)):(?<strength>(?:\d+)):(?<dexterity>(?:\d+)):(?<vitality>(?:\d+)):(?<intelligence>(?:\d+)):(?<mind>(?:\d+)):(?<piety>(?:\d+)):(?<attackPower>(?:\d+)):(?<directHit>(?:\d+)):(?<criticalHit>(?:\d+)):(?<attackMagicPotency>(?:\d+)):(?<healMagicPotency>(?:\d+)):(?<determination>(?:\d+)):(?<skillSpeed>(?:\d+)):(?<spellSpeed>(?:\d+)):[^:]*:(?<tenacity>(?:\d+)):(?<localContentId>(?:.*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) StartsCasting 14:(?<sourceId>(?:[0-9A-F]{8})):(?<source>(?:[^:]*?)):(?<id>(?:[0-9A-Fa-f]{1,8})):(?<ability>(?:[^:]*?)):(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):(?<castTime>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<x>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<y>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<z>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<heading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) (?:ActionEffect 15|AOEActionEffect 16):(?<sourceId>(?:[0-9A-F]{8})):(?<source>(?:[^:]*?)):(?<id>(?:[0-9A-Fa-f]{1,8})):(?<ability>(?:[^:]*?)):(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):(?<flags>(?:[^:]*?)):(?<flag0>(?:[^:]*?)):(?<flag1>(?:[^:]*?)):(?<flag2>(?:[^:]*?)):(?<flag3>(?:[^:]*?)):(?<flag4>(?:[^:]*?)):(?<flag5>(?:[^:]*?)):(?<flag6>(?:[^:]*?)):(?<flag7>(?:[^:]*?)):(?<flag8>(?:[^:]*?)):(?<flag9>(?:[^:]*?)):(?<flag10>(?:[^:]*?)):(?<flag11>(?:[^:]*?)):(?<flag12>(?:[^:]*?)):(?<flag13>(?:[^:]*?)):(?<flag14>(?:[^:]*?)):(?:(?<targetHp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetMaxHp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetMp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetMaxMp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)?:(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)?:(?:(?<targetX>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetY>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetZ>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<targetHeading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?<hp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<maxHp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<mp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<maxMp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?:(?<x>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<y>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<z>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<heading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<sequence>(?:[^:]*?)):(?<targetIndex>(?:[^:]*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) Death 19:(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):(?<sourceId>(?:[0-9A-F]{8})):(?<source>(?:[^:]*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) StatusAdd 1A:(?<effectId>(?:[^:]*?)):(?<effect>(?:[^:]*?)):(?<duration>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<sourceId>(?:[0-9A-F]{8})):(?<source>(?:[^:]*?)):(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):(?<count>(?:[^:]*?)):(?<targetMaxHp>(?:[^:]*?)):(?<sourceMaxHp>(?:[^:]*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) TargetIcon 1B:(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):....:....:(?<id>(?:....)):
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) StatusRemove 1E:(?<effectId>(?:[^:]*?)):(?<effect>(?:[^:]*?)):(?<duration>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<sourceId>(?:[0-9A-F]{8})):(?<source>(?:[^:]*?)):(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):(?<count>(?:[^:]*?)):(?<targetMaxHp>(?:[^:]*?)):(?<sourceMaxHp>(?:[^:]*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) Director 21:(?<instance>(?:.*?)):(?<command>(?:.*?)):(?<data0>(?:.*?)):(?<data1>(?:.*?)):(?<data2>(?:.*?)):(?<data3>(?:.*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) StatusList 26:(?<targetId>(?:[0-9A-F]{8})):(?<target>(?:[^:]*?)):[0-9A-F]{0,6}(?<job>(?:[0-9A-F]{0,2})):(?<hp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<maxHp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<mp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):(?<maxMp>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)):.*?:.*?:(?:(?<x>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<y>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<z>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?:(?<heading>(?:-?[0-9]+(?:[.,][0-9]+)?(?:E-?[0-9]+)?)))?:(?<data0>(?:[^:]*?)):(?<data1>(?:[^:]*?)):(?:(?<data2>(?:[^:]*?)):)?(?:(?<data3>(?:[^:]*?)):)?(?:(?<data4>(?:[^:]*?)):)?
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) ChangeMap 28:(?<id>(?:[^:]*?)):(?<regionName>(?:[^:]*?)):(?<placeName>(?:[^:]*?)):(?<placeNameSub>(?:[^:]*?))$
```
...
ACT Log Line Regex:
(?<timestamp>(?:^.{14})) SystemLogMessage 29:[^:]*?:(?<id>(?:[^:]*?)):(?<param0>(?:[^:]*?)):(?<param1>(?:[^:]*?)):(?<param2>(?:[^:]*?))$
```
