...
Options.Triggers.push({
  ...
  triggers: [
    ...
    },
    {
      ...
      outputStrings: {
        text: {
          en: 'First fire on YOU (w/ ${partner})',
          ja: '自分に初炎 (${partner})',
        },
      },
    },
    ...
    },
    {
      ...
      response: (data, matches, output) => {
        ...
        output.responseOutputStrings = {
          puddle: {
            en: '#${num} Puddle on YOU',
            ja: '自分に${num}番目の炎',
          },
          puddle1st: {
            en: 'First Puddle on YOU! Pass to next!',
            ja: '自分に1番目の炎！次に移る！',
          },
        };
