...
const miscStrings = {
  ...
  description: {
    ...
    de: 'Diese Liste kann Inhalte beinhalten, welche momentan in entwicklung sind uns sich noch nicht im aktuellsten Cactbot Release befinden. Alles was hier aufgelistet ist, wird sich im nächsten Release von Cactbot befinden. Wenn du <a href="https://github.com/quisquous/cactbot/blob/main/CONTRIBUTING.md#validating-changes-via-remote-urls">quisquous.github.io version</a> als URL für dein Overlay benutzt, ist diese Liste bereits aktuell für dich.',
